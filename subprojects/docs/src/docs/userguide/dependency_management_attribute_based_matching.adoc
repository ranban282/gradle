...
It starts with the requested attributes and then considers all transforms which modify some of the requested attributes as possible paths to lead there.
...
The produced artifacts replace the input artifact in the order they were registered in the transformed variant.
